...
$signos = [
  ...
  ['nome' => 'Touro', "periodo" => '20/04 - 20/05', 'descricao' => "Prático e determinado."],
  ['nome' => 'Gêmeos', "periodo" => '21/05 - 20/06', 'descricao' => "Comunicativo e versátil."],
  ['nome' => 'Câncer', "periodo" => '21/06 - 22/07', 'descricao' => "Emocional e protetor."],
  ['nome' => 'Leão', "periodo" => '23/07 - 22/08', 'descricao' => "Confiante e generoso."],
  ['nome' => 'Virgem', "periodo" => '23/08 - 22/09', 'descricao' => "Analítico e detalhista."],
  ['nome' => 'Libra', "periodo" => '23/09 - 22/10', 'descricao' => "Diplomático e justo."],
  ['nome' => 'Escorpião', "periodo" => '23/10 - 21/11', 'descricao' => "Intenso e misterioso."],
  ...
  ['nome' => 'Aquário', "periodo" => '20/01 - 18/02', 'descricao' => "Inovador e humanitário."],
